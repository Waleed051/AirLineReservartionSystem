...
public class PrintTicket1 extends JFrame
{
	...
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, String sBookedBy, Integer iPrice, String sTime)
	{
		...
		LTeam.setBounds(285,485,300,20);
		LRehman.setBounds(285,505,300,20);
		LAshar.setBounds(285,525,300,20);
		LMather.setBounds(285,545,300,20);
		LWaleed.setBounds(285,565,300,20);
